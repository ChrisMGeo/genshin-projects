...
const characterInfoLines = [
  ...
  `export type CharacterInfo = typeof characterInfo["characterInfo"][number];`,
  `export type CharacterKey = CharacterInfo["id"];`,
...
const weaponInfoLines = [
  ...
  `export type WeaponInfo = typeof weaponInfo["weaponInfo"][number];`,
  `export type WeaponKey = WeaponInfo["id"];`,
